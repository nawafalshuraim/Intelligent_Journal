...
_$BingImageImpl _$$BingImageImplFromJson(Map<String, dynamic> json) =>
    _$BingImageImpl(
      images:
...
Map<String, dynamic> _$$BingImageImplToJson(_$BingImageImpl instance) =>
    <String, dynamic>{
      if (instance.images case final value?) 'images': value,
      if (instance.tooltips case final value?) 'tooltips': value,
    };

_$TooltipsImpl _$$TooltipsImplFromJson(Map<String, dynamic> json) =>
    _$TooltipsImpl(
...
Map<String, dynamic> _$$TooltipsImplToJson(_$TooltipsImpl instance) =>
    <String, dynamic>{
