...
Future<void> _initSystem() async {
  ...
  await HiveUtil().init();
  debugPrint('>> before RustLib.init');
  try {
    await RustLib.init();
  } catch (e, s) {
    debugPrint('RustLib.init error: $e\n$s');
  }
  debugPrint('>> after RustLib.init');
  unawaited(_platFormOption());
  WebDavUtil().initWebDav();
  debugPrint('>> before buildTheme');
  await ThemeUtil().buildTheme();
  debugPrint('>> before fvp.registerWith');
  fvp.registerWith();
  debugPrint('>> _initSystem done');
